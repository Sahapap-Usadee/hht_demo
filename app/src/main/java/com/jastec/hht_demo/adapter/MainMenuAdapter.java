...
public class MainMenuAdapter extends ExpandableRecyclerAdapter<MainMenuAdapter.ListItem> {
        ...
        public void bind(final int position) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    onItemClickListener.onItemClick(view, visibleItems.get(position).Id,visibleItems.get(position).Text);
                }
            });
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
     ...
     //   divider.setBackgroundColor(context.getResources().getColor(R.color.grey_60));
        divider.setBackgroundColor(ContextCompat.getColor(context,R.color.grey_60));
        if (viewType == NORMAL) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, int itemId,String itemText);
    }
}
